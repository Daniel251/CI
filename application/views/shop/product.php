    ...
    <div class='row'>
        <div class='col-xs-2 img'>
            ...
            <?php foreach ($images as $img): ?>
                <a href='<?php echo base_url() ?>images/products/<?php echo $img ?>'
                   data-lightbox='<?php echo $product->nr ?>'>
        ...
        <div class='col-xs-10'>
            ...
            <div class='row'>
                ...
                <div class='col-sm-4'>
                    <div class='button'>
                        <button type='button' id='<?php echo $product->id ?>' class='btn btn-warning btn-xs add-to-cart'>
