...
<?php echo form_open_multipart('cms/admin/add_video') ?>
    <div class="form-group">
        ...
        <input type="text" name="description" class="form-control input"
               value='<?php echo $this->session->flashdata('description') ?>' required>
    </div>
    <div class="form-group">
        <label>Link</label>
        <input type="text" name="link" class="form-control input" value='<?php echo $this->session->flashdata('link') ?>'
               required>
    </div>
    <div class="form-group">
        <label>Zdjęcie</label>
