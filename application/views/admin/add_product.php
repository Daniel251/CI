...
<div class='form-group'>
    <label>Cena</label>
    <input type='number' name='price' step='0.01' class='form-control number' value='<?php echo number_format($this->session->flashdata('price'), 2) ?>' required>
</div>
<div class='form-group'>
    <label>Opis</label>
    <textarea name='description' class='form-control input' rows='3'><?php echo $this->session->flashdata('description') ?></textarea>
</div>
<div class='form-group'>
