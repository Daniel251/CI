<?= form_open_multipart('cms/admin/edit_news/'.$news->id) ?>
    <div class="form-group">
        <label>Tytuł posta</label>
        <input type="text" name="title" class="form-control input" value='<?= $news->title ?>' required>
    </div>
    <div id='news-date' class="form-group">
                <label>Data i godzina posta</label>
                <input type="datetime" name="date" class="form-control input" value='<?= $news->date ?>' required>
            </div>
    <div class="form-group">
        <div class="checkbox">
            <label>
    ...
    <div class="form-group">
        ...
        <textarea name='post' class="form-control input" rows="5"><?= $news->post ?></textarea>
    </div>
    <div class="form-group">
