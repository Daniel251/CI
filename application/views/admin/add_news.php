...
<div class="form-group">
    ...
    <input type="text" name="title" class="form-control input" value='<?php echo $this->session->flashdata('title') ?>' required>
</div>
<div id='news-date' class="form-group">
    <label>Data posta</label>
    <input type="date" name="date" value='<?php echo $this->session->flashdata('date') ?>' class="form-control input">
    <label>Godzina posta</label>
    <input type="time" name="time" value='<?php echo $this->session->flashdata('time') ?>' class="form-control input">
</div>
<div class="form-group">
    <div class="checkbox">
        <label>
