...
<body>
	<nav>
		...
		<ul class="clearfix menu">
			<li><a href="<?php echo base_url() ?>">ZESPÓŁ</a></li>
			<li><a href="<?php echo base_url() ?>news/index/1">NEWSY</a></li>
			<li><a href="<?php echo base_url() ?>concerts">KONCERTY</a></li>
			<li><a href="<?php echo base_url() ?>videos">FILMY</a></li>
